...
class Battle(models.Model):
    ...
    attacker_1 = models.CharField(max_length=200, blank=True, null=True)
    attacker_2 = models.CharField(max_length=200, blank=True, null=True)
    attacker_3 = models.CharField(max_length=200, blank=True, null=True)
    attacker_4 = models.CharField(max_length=200, blank=True, null=True)
    defender_1 = models.CharField(max_length=200, blank=True, null=True)
    defender_2 = models.CharField(max_length=200, blank=True, null=True)
    defender_3 = models.CharField(max_length=200, blank=True, null=True)
    defender_4 = models.CharField(max_length=200, blank=True, null=True)
    ...
    attacker_size = models.CharField(max_length=200, blank=True, null=True)
    defender_size = models.CharField(max_length=200, blank=True, null=True)
